    ...
    rows.extend(
        ...
        for text in variants(
            (
                ...
                "покажи фотографии Москвы", "покажи фотографии Кривого Рога",
                "покажи фото Красной площади", "покажи картинки котов",
                "найди изображения северного сияния", "как выглядит Эйфелева башня",
                "покажи фотографии старого города", "найди фото поверхности Марса",
            )
        )
    )
