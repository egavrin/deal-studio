...
EXPORT_INTENT_CHECKS = [
    ...
    ("Построй маршрут до Красной площади", "start_navigation", 0.75, True),
    ("Добавь в календарь встреча с командой", "create_calendar_event", 0.75, True),
    ("Музыка: следующий трек", "control_media", 0.75, True),
    ("Сделай громче", "set_volume", 0.75, True),
    ("Открой настройки Wi-Fi", "open_setting", 0.75, True),
    ("Открой сайт https://developer.android.com", "open_url", 0.75, True),
]
